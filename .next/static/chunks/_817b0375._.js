            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(submissionsQuery, {
                "CheatersPage.useEffect.unsubscribe": async (snapshot)=>{
                    ...
                    const students = studentsSnap.docs.map({
                        "CheatersPage.useEffect.unsubscribe.students": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["CheatersPage.useEffect.unsubscribe.students"]);
                    const exams = examsSnap.docs.map({
                        "CheatersPage.useEffect.unsubscribe.exams": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["CheatersPage.useEffect.unsubscribe.exams"]);
                    const cheaterDetails = flaggedSubmissions.map({
                        "CheatersPage.useEffect.unsubscribe.cheaterDetails": (sub)=>{
                            const student = students.find({
                                "CheatersPage.useEffect.unsubscribe.cheaterDetails.student": (s)=>s.id === sub.studentId
                            }["CheatersPage.useEffect.unsubscribe.cheaterDetails.student"]);
                            const exam = exams.find({
                                "CheatersPage.useEffect.unsubscribe.cheaterDetails.exam": (e)=>e.id === sub.examId
                            }["CheatersPage.useEffect.unsubscribe.cheaterDetails.exam"]);
                            return {
                                submissionId: sub.id,
                    ...
                    }["CheatersPage.useEffect.unsubscribe.cheaterDetails"]);
...
_c = CheatersPage;
const __TURBOPACK__default__export__ = _c1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$withAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(CheatersPage, [
    'teacher'
]);
var _c, _c1;
...
//# sourceMappingURL=_817b0375._.js.map